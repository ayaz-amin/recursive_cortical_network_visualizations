...
class LoopyBPInference(object):
    ...
    def bwd_pass(self):
        ...
        assignments, backtrace, score = self.decode()
    ...
    def decode(self):
        ...
        backtrace, score = recount(backtrace_positions, self.bu_msg, self.preproc_layer.pos_filters)
        return assignments, backtrace, score
...
def recount(backtrace_positions, bu_msg, filters):
    ...
    return weight_sum, normalized_score